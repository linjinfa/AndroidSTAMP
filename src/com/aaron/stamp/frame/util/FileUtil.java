...
import com.aaron.library.frame.util.MemorySpaceCheckUtil;
...
public class FileUtil {
	...
	public static String getDataPath() {
		if (MemorySpaceCheckUtil.checkSDCard()) {
			 return SDCard+"/Android/data/"+AaronConstants.PACKAGE_NAME+"/";
//			return SDCard + "/";
		} else {
			return "/data/data/" + AaronConstants.PACKAGE_NAME + "/";
		}
	}
